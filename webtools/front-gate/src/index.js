// Avvio del server.
//
// In background: ./webtools_front_gate.sh --start
...
try {
  ...
  console.error(`webtools_front_gate non parte: ${error.message}`);
  process.exit(1);
}
...
server.listen(settings.port, settings.host, () => {
  ...
  console.log(`webtools_front_gate in ascolto su http://${settings.host}:${settings.port}`);
});
